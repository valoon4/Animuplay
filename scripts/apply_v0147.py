...
# Apply only to the player opening block. There can be similar UI-hide sequences elsewhere,
# but the first matching block after openPlayer() is the one that leaked ANIME/RL over the player.
